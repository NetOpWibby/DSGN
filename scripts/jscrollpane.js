	...
	$.fn.jScrollPane = function (settings) {
		...
		function JScrollPane(elem, s) {
			...
			function initialise(s) {
				...
				var
				/*firstChild, lastChild, */ isMaintainingPositon, lastContentX, lastContentY,
			...
			$.extend(jsp, {
				...
				scrollByX: function (deltaX, animate) {
					var
					destX = contentPositionX() + Math[deltaX < 0 ? 'floor' : 'ceil'](deltaX),
