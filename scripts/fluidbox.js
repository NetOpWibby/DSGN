...
(function($) {
	$.fn.fluidbox = function(opts) {
		var settings = $.extend(true, {
			viewportFill: 0.95,
			overlayColor: "rgba(25,25,25,0.85)",
			debounceResize: true,
			closeTrigger: [{
		...
		$fb.imagesLoaded().done(function() {
			$fb.each(function(i) {
				if ($(this).is("a") && $(this).children().length === 1 && $(this).children().is("img")) {
					$(this).addClass("fluidbox").wrapInner('<div class="fluidbox-wrap"/>').find("img").css({
						opacity: 1
				...
				$fb.click(function(e) {
					if ($(this).hasClass("fluidbox")) {
						...
						if ($(this).data("fluidbox-state") === 0 || !$(this).data("fluidbox-state")) {
							$(this).data("fluidbox-state", 1).removeClass("fluidbox-closed").addClass("fluidbox-opened");
							...
							$(this).data("fluidbox-state", 0).removeClass("fluidbox-opened").addClass("fluidbox-closed");
							$("#fluidbox-overlay").fadeOut();
							$ghost.css({
								"transform": "translate(0,0) scale(1)"
							}).one("transitionend oTransitionEnd otransitionend MSTransitionEnd webkitTransitionEnd", function() {
								$ghost.css({
									opacity: 0
								});
								$img.css({
