	...
	(function (n, t) {
		...
		var e = function (n, t) {
			...
			e.onload = function () {
				...
				var o = r.getImageData(0, 0, n.width, n.height);
				t && t(o.data)
		...
		c.colors = function (n, t, a) {
			e(n, function (n) {
				...
				l = {
					...
					palette: Array.apply(null, Array(a || u)).map(Boolean).map(function (n) {
						return {
							name: "0,0,0",
							count: 0
						}
